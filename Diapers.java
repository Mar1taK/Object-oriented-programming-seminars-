public class Diapers extends ProductOfChildren {
    private int size;
    ...
    public String toString() {
        return String.format("Наименование: %s; Цена: %d; Кол-во: %d; Ед. изм.: %s; Мин.возраст: %d; Гипоаллергенность: %s; Размер: %d; Мин. вес: %d; Макс. вес: %d; Тип: %s", 
